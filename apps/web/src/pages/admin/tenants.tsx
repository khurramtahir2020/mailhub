...
export function AdminTenantsPage() {
  ...
  const platformStats = [
    ...
    {
      label: 'Delivered',
      value: (usage?.emailsDelivered ?? 0).toLocaleString(),
      sub: 'Successfully delivered',
      color: 'from-emerald-500 to-emerald-400',
    },
    {
      label: 'Bounced',
      value: (usage?.emailsBounced ?? 0).toLocaleString(),
      sub: 'Hard + soft bounces',
      color: 'from-amber-500 to-orange-400',
    },
    {
      label: 'Complaints',
      value: (usage?.emailsComplained ?? 0).toLocaleString(),
      sub: 'Spam reports',
                      ...
                      {tenant.mode === 'sandbox' && (
                        <button
                          ...
                          onClick={() => promote.mutate({ tenantId: tenant.id }, {
                            onSuccess: () => toast.success('Tenant promoted to production'),
                          })}
